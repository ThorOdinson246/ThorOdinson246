...
export function Sketchbook() {
  ...
  return (
    <div className="relative min-h-full w-full" style={{ color: INK }}>
      {/* Doodling is on by default: drag on any empty paper to draw. */}
      <SketchPad enabled />

      <div className="pointer-events-none relative z-10 mx-auto flex max-w-3xl flex-col items-center px-5 py-10 text-center sm:px-10 sm:py-12">
