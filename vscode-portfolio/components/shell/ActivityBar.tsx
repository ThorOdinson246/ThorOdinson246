...
function SettingsGlyph() {
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
      ...
      <path
        d="M12 2.5l1.2 2.1 2.4-.3.6 2.3 2.2 1-.6 2.3 1.5 1.9-1.5 1.9.6 2.3-2.2 1-.6 2.3-2.4-.3L12 21.5l-1.2-2.1-2.4.3-.6-2.3-2.2-1 .6-2.3L4.7 12l1.5-1.9-.6-2.3 2.2-1 .6-2.3 2.4.3z"
        stroke="currentColor"
        strokeWidth="1.2"
